...
class Follower():
    def __init__(self):
        ...
        self.position_subscriber = rospy.Subscriber('/robot_cmd_stamped', TwistStamped, self.set_cmd_vel, queue_size=5)

        rospy.loginfo("Subscribing to robot_cmd_stamped......")

        # Wait for the  topic to become available
        rospy.wait_for_message('/robot_cmd_stamped', TwistStamped)
